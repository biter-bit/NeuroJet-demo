...
![Рост активных пользователей](./active_users.png)
![Рост запросов](./load_request.png)
...
![Уменьшение нагрузки после оптимизации запросов SQL](./optimization.png)
![Уменьшение нагрузки после внедрения Redis](./load_reduction.png)
...
![Увеличение скорости выпуска обновлений и деплоя](./speed_deploy.png)
